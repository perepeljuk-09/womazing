        ...
        <main className="main">
            <div className="container">
                <section className="about">
                    ...
                    <div className="block__about">
                        <div className="info">
                            <h3 className="info__title">Магия в деталях</h3>
                    ...
                    <Link to="/shop" className="shop__btn">Перейти в магазин</Link>
                </section>
            </div>
        </main>);
};
